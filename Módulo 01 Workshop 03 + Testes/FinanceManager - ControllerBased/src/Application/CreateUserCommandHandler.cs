...
public record struct CreateUserRequest(
    ...
    string Email,
    string Password,
    string ConfirmPassword) : IRequest<CommandResult<CreateUserResponse>>;
...
public class CreateUserCommandHandler(
    ...
    UserManager<UserAccount> userManager) : IRequestHandler<CreateUserRequest, CommandResult<CreateUserResponse>>
{
