...
public record struct LoginRequest(
    string Email,
    string Password) : IRequest<CommandResult<LoginResponse>>;
...
public class LoginCommandHandler(
    ...
    ITokenProviderService tokenProviderService) : IRequestHandler<LoginRequest, CommandResult<LoginResponse>>
{
